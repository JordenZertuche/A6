...
public class IndividualPane extends GridPane {
    ...
    public IndividualPane(Individual individual) {
        ...
        // try {
        // nameField.setText(individual.getName());
        // emailField.setText(individual.getEmail());
        // phoneField.setText(individual.getPhone());
        // passwordField.setText(individual.getPassword());
        // securityQuestionField.setText(individual.getSecurityQuestion());
        // addressField.setText(individual.getAddress());
        // avatarField.setText(individual.getAvatar());
        // } catch (Exception e) {

            //if this exception is thrown then the program will print out the error message
            // as well as the program will crash and show the user nothing other then the box
        ...
        //create a exception for the avatar
        try {
        ...
        //create a exception for each attribute
        try {
            nameLabel = new Label("Name: " + individual.getName());
        } catch (Exception e) {
            //if this exception is thrown then the program will print out the error message
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                //create a exception for the individual class
                try {
                    individual.setSecurityQuestion(securityQuestionField.getText());
                } catch (Exception e) {
                    //if this exception is thrown then the program will print out the error message
                    // as well as the program will crash and show the user nothing other then the box
        ...
        redSlider.valueProperty().addListener((observable, oldValue, newValue) -> {
            ...
            //create a exception handler for the slider
            try {
                //update the individual attribute with the new data
                individual.setSecurityQuestion(securityQuestionField.getText());
                //set the securityQuestion label to the securityQuestionField text
                securityQuestionLabel.setText("Security Q: " + securityQuestionField.getText());
            } catch (Exception e) {
                //if this exception is thrown then the program will print out the error message
                // as well as the program will crash and show the user nothing other then the box
                System.out.println("Error: " + e.getMessage());
